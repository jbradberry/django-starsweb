...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Race.default_racepage'
        db.delete_column(u'starsweb_race', 'default_racepage_id')


    def backwards(self, orm):
        # Adding field 'Race.default_racepage'
        db.add_column(u'starsweb_race', 'default_racepage',
