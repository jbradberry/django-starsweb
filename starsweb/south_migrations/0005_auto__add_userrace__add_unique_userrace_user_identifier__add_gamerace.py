...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'UserRace'
        db.create_table(u'starsweb_userrace', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='racepool', to=orm['auth.User'])),
            ('identifier', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('racefile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['starsweb.StarsFile'], null=True)),
        ))
        db.send_create_signal(u'starsweb', ['UserRace'])

        # Adding unique constraint on 'UserRace', fields ['user', 'identifier']
        db.create_unique(u'starsweb_userrace', ['user_id', 'identifier'])

        # Adding model 'GameRace'
        db.create_table(u'starsweb_gamerace', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('race', self.gf('django.db.models.fields.related.ForeignKey')(related_name='official', unique=True, to=orm['starsweb.Race'])),
            ('racefile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['starsweb.StarsFile'])),
        ))
        db.send_create_signal(u'starsweb', ['GameRace'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserRace', fields ['user', 'identifier']
        db.delete_unique(u'starsweb_userrace', ['user_id', 'identifier'])

        # Deleting model 'UserRace'
        db.delete_table(u'starsweb_userrace')

        # Deleting model 'GameRace'
        db.delete_table(u'starsweb_gamerace')
