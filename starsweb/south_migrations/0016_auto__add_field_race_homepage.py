...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Race.homepage'
        db.add_column(u'starsweb_race', 'homepage',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['starsweb.RacePage']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Race.homepage'
        db.delete_column(u'starsweb_race', 'homepage_id')
    ...
    models = {
        ...
        u'starsweb.ambassador': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'starsweb_ambassadors'", 'to': u"orm['auth.User']"})
        },
        u'starsweb.game': {
            ...
            'host': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'starsweb_games'", 'to': u"orm['auth.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'starsweb.race': {
            ...
            'default_racepage': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'to': u"orm['starsweb.RacePage']"}),
            'game': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'races'", 'to': u"orm['starsweb.Game']"}),
            'homepage': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'null': 'True', 'to': u"orm['starsweb.RacePage']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'starsweb.racepage': {
            'Meta': {'object_name': 'RacePage'},
            'body': ('django.db.models.fields.TextField', [], {}),
            'body_html': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'markup_type': ('django.db.models.fields.CharField', [], {'default': "'markdown'", 'max_length': '32'}),
            'race': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'racepages'", 'to': u"orm['starsweb.Race']"}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '32'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '32'})
        },
        u'starsweb.raceturn': {
            'Meta': {'object_name': 'RaceTurn'},
            'hfile': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'hraceturn'", 'null': 'True', 'to': u"orm['starsweb.StarsFile']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mfile': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'mraceturn'", 'to': u"orm['starsweb.StarsFile']"}),
            'race': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'raceturns'", 'to': u"orm['starsweb.Race']"}),
            'turn': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'raceturns'", 'to': u"orm['starsweb.Turn']"}),
            'uploads': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'xfile': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'xraceturn'", 'null': 'True', 'to': u"orm['starsweb.StarsFile']"}),
            'xfile_official': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'official_xraceturn'", 'null': 'True', 'to': u"orm['starsweb.StarsFile']"})
        },
        u'starsweb.score': {
        ...
        u'starsweb.starsfile': {
            ...
            'upload_user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'starsweb_files'", 'null': 'True', 'to': u"orm['auth.User']"})
        },
        u'starsweb.turn': {
            ...
            'hstfile': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'hstturn'", 'null': 'True', 'to': u"orm['starsweb.StarsFile']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'starsweb.userrace': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'starsweb_racepool'", 'to': u"orm['auth.User']"})
        }
    }
