...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RaceTurn'
        db.create_table(u'starsweb_raceturn', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('race', self.gf('django.db.models.fields.related.ForeignKey')(related_name='raceturns', to=orm['starsweb.Race'])),
            ('turn', self.gf('django.db.models.fields.related.ForeignKey')(related_name='raceturns', to=orm['starsweb.Turn'])),
            ('mfile', self.gf('django.db.models.fields.related.ForeignKey')(related_name='mraceturn', to=orm['starsweb.StarsFile'])),
            ('hfile', self.gf('django.db.models.fields.related.ForeignKey')(related_name='hraceturn', null=True, to=orm['starsweb.StarsFile'])),
            ('xfile', self.gf('django.db.models.fields.related.ForeignKey')(related_name='xraceturn', null=True, to=orm['starsweb.StarsFile'])),
            ('xfile_official', self.gf('django.db.models.fields.related.ForeignKey')(related_name='official_xraceturn', null=True, to=orm['starsweb.StarsFile'])),
            ('uploads', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'starsweb', ['RaceTurn'])


    def backwards(self, orm):
        # Deleting model 'RaceTurn'
        db.delete_table(u'starsweb_raceturn')
