...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'RaceFile'
        db.delete_table(u'starsweb_racefile')
        ...
        # Adding model 'StarsFile'
        db.create_table(u'starsweb_starsfile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('upload_user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='starsfiles', null=True, to=orm['auth.User'])),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
        ))
        db.send_create_signal(u'starsweb', ['StarsFile'])


        # Changing field 'GameRaceFile.racefile'
        db.alter_column(u'starsweb_gameracefile', 'racefile_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['starsweb.StarsFile']))

        # Changing field 'Race.racefile'
        db.alter_column(u'starsweb_race', 'racefile_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['starsweb.StarsFile'], null=True))
    ...
    def backwards(self, orm):
        ...
        # Adding model 'RaceFile'
        db.create_table(u'starsweb_racefile', (
            ...
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='racefiles', to=orm['auth.User'])),
            ('file', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'starsweb', ['RaceFile'])

        # Deleting model 'UserRaceFile'
        db.delete_table(u'starsweb_userracefile')

        # Deleting model 'StarsFile'
        db.delete_table(u'starsweb_starsfile')


        # Changing field 'GameRaceFile.racefile'
        db.alter_column(u'starsweb_gameracefile', 'racefile_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['starsweb.RaceFile']))

        # Changing field 'Race.racefile'
        db.alter_column(u'starsweb_race', 'racefile_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['starsweb.RaceFile'], null=True))
