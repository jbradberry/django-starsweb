...
class OrderFileDownloadTestCase(TestCase):
    def setUp(self):
        self.user = User.objects.create_user(username='admin',
                                             password='password')
        self.client.login(username='admin', password='password')
        ...
        self.raceturn = self.turn.raceturns.create(race=self.race,
                                                   mfile=self.starsfile,
                                                   xfile=self.starsfile)

        self.download_url = reverse('orders_download',
                                    kwargs={'game_slug': 'total-war-in-ulfland',
                                            'race_slug': 'gestalti'})
    ...
    def test_authorized(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertEqual(response['Content-Disposition'],
                         'attachment; filename="total-wa.x1"')
        self.assertEqual(response['Content-length'], '9')
    ...
    def test_game_does_not_exist(self):
        ...
        download_url = reverse('orders_download',
                               kwargs={'game_slug': '500-years-after',
                                       'race_slug': 'gestalti'})
...
class OrderFileUploadTestCase(TestCase):
    def setUp(self):
        self.user = User.objects.create_user(username='admin', password='password')
        self.client.login(username='admin', password='password')
        ...
        self.upload_url = reverse('orders_upload',
                                  kwargs={'game_slug': 'total-war-in-ulfland',
                                          'race_slug': 'gestalti'})
    ...
    def test_authorized(self):
        ...
        raceturn = models.RaceTurn.objects.get()
        self.assertIsNotNone(raceturn.xfile)
    ...
    def test_file_not_order_file(self):
        self.assertEqual(models.StarsFile.objects.count(), 1)
        self.assertIsNone(self.raceturn.xfile)
    ...
    def test_game_does_not_exist(self):
        ...
        upload_url = reverse('orders_upload',
                             kwargs={'game_slug': '500-years-after',
                                     'race_slug': 'gestalti'})
...
class HistoryFileDownloadTestCase(TestCase):
    def setUp(self):
        self.user = User.objects.create_user(username='admin',
                                             password='password')
        self.client.login(username='admin', password='password')
        ...
        self.turn = self.game.turns.create(year=2400)
        self.raceturn = self.turn.raceturns.create(race=self.race,
                                                   hfile=self.starsfile,
                                                   mfile=self.starsfile,
                                                   xfile=self.starsfile)

        self.download_url = reverse('history_download',
                                    kwargs={'game_slug': 'total-war-in-ulfland',
                                            'race_slug': 'gestalti'})
    ...
    def test_authorized(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertEqual(response['Content-Disposition'],
                         'attachment; filename="total-wa.h1"')
        self.assertEqual(response['Content-length'], '9')
...
class HistoryFileUploadTestCase(TestCase):
    def setUp(self):
        self.user = User.objects.create_user(username='admin', password='password')
        self.client.login(username='admin', password='password')
        ...
        self.upload_url = reverse('history_upload',
                                  kwargs={'game_slug': 'total-war-in-ulfland',
                                          'race_slug': 'gestalti'})
    ...
    def test_authorized(self):
        ...
        self.assertEqual(models.StarsFile.objects.count(), 2)
        raceturn = models.RaceTurn.objects.get()
        self.assertIsNotNone(raceturn.hfile)
