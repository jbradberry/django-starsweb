...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Game.mapfile'
        db.add_column(u'starsweb_game', 'mapfile',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['starsweb.StarsFile'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Game.mapfile'
        db.delete_column(u'starsweb_game', 'mapfile_id')
