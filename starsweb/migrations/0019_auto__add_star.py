...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Star'
        db.create_table(u'starsweb_star', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('game', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['starsweb.Game'])),
        ...
        db.send_create_signal(u'starsweb', ['Star'])


    def backwards(self, orm):
        # Deleting model 'Star'
        db.delete_table(u'starsweb_star')
    ...
    models = {
        ...
        u'starsweb.star': {
            ...
            'game': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['starsweb.Game']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
