...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Turn.hstfile'
        db.add_column(u'starsweb_turn', 'hstfile',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='hstturn', null=True, to=orm['starsweb.StarsFile']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Turn.hstfile'
        db.delete_column(u'starsweb_turn', 'hstfile_id')
