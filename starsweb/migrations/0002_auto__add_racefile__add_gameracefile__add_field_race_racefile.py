...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'starsweb_gameracefile', (
            ...
            ('racefile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['starsweb.RaceFile'])),
        ))
        db.send_create_signal(u'starsweb', ['GameRaceFile'])

        # Adding field 'Race.racefile'
        db.add_column(u'starsweb_race', 'racefile',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['starsweb.RaceFile'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Race.racefile'
        db.delete_column(u'starsweb_race', 'racefile_id')
