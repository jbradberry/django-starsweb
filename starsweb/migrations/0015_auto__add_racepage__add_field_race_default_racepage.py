...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RacePage'
        db.create_table(u'starsweb_racepage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('race', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['starsweb.Race'])),
        ...
        db.send_create_signal(u'starsweb', ['RacePage'])
    ...
    def backwards(self, orm):
        # Deleting model 'RacePage'
        db.delete_table(u'starsweb_racepage')
    ...
    models = {
        ...
        u'starsweb.racepage': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'markup_type': ('django.db.models.fields.CharField', [], {'default': "'markdown'", 'max_length': '32'}),
            'race': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['starsweb.Race']"}),
