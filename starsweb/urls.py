...
urlpatterns = patterns('',
    ...
    url(r'^user/race/upload/(?P<pk>\d+)/$', views.UserRaceUpload.as_view(),
        name='userrace_upload'),
    url(r'^user/race/create/$', views.UserRaceCreate.as_view(),
        name='userrace_create'),
    url(r'^user/race/update/(?P<pk>\d+)/$', views.UserRaceUpdate.as_view(),
        name='userrace_update'),
    url(r'^user/race/delete/(?P<pk>\d+)/$', views.UserRaceDelete.as_view(),
